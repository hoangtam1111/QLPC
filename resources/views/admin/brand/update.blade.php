        ...
        <form action="{{ route('admin.brand.post-update') }}" method="post" enctype="multipart/form-data">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="{{ old('brand_name') ?? $brand->brand_name }}" class="form-control"
                            id="brand_name" placeholder="Tên thương hiệu" name="brand_name" />
                        @error('brand_name')
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="{{ old('brand_logo') ?? $brand->brand_logo }}" class="form-control"
                            id="brand_logo" placeholder="Link logo" name="brand_logo" />
                        @error('brand_logo')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </td>
